#### Megan Nash Data Science Portfolio

## Portfolio At a Glance

**Tidy Data Analysis**
 * A comprehensive Jupyter Notebook project focused on advanced data cleaning and restructuring techniques to transform messy raw data into a standardized format for statistical exploration
 * Pandas, Seaborn, Statistics
 * Notebook: (https://github.com/megnash14/Nash-Data-Science-Portfolio/blob/main/TidyData-Project%20/tidy_data_analysis.ipynb)
...
* Regression, Random Forest, Streamlit
* Streamlit Link:(https://megnash14-nash-data-science-portfolio-mlsupervisedapp-nil5cf.streamlit.app/)

**Unsupervised ML Explorer**
* An interactive dashboard featuring the World Happiness dataset that implements PCA and clustering models (K-Means and Hierarchical) to discover hidden data structures
