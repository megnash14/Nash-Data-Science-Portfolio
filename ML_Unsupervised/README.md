...
- **K-Means Clustering:** Includes real-time Silhouette Score and Elbow Plot.
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/YOUR_USERNAME/LASTNAME-Data-Science-Portfolio.git](https://github.com/megnash14/Nash-Data-Science-Portfolio.git)